...
const { validateToken, validateAdminToken } = require("../config/auth");
...
module.exports = app => {
	...
	app
		...
		.get(validateAdminToken, getUsers); // checks if user is an Admin, then gives priveledge to view all users
